...
const SignUp = () => {
  const [mailOrphone, setMobileOrEmail] = useState("");
  ...
  //       text2: "Please enter username and mobile/email.",
  //     });
  //     return;
  //   }

  //   console.log("Sending request with:", { username, mailOrphone });
    ...
    try {
      ...
      if (response.status === 200) {
        Toast.show({
          type: "success",
          text1: "Otp sent",
          text2: "Wait for a second!",
        });
        console.log(response.data.Email);
        router.push({
          pathname: "/(component)/Otp",
          query: {
